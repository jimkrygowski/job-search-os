...
Confirmed 2026-09-17: a CarGurus networking coffee was confirmed and put
on the calendar for 9 days out, but the scan's own week-window fetch
couldn't see that far, so it kept reporting the tracker's stale
"unconfirmed, TBD" line instead of catching that it had already been
resolved. The week-window fetch above is for routine visibility, not for
catching this — it won't, by construction.
