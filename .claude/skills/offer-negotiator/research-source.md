# Offer Negotiator Skill — Full Source Citations

Full bibliographic detail for every source cited in `research.md`, split
out here so that file stays focused on what actually drives the skill's
advice (evidence quality, known limitations, how to use correctly) rather
than carrying full author/journal/volume/page/DOI detail inline. Each
entry below is linked from the corresponding subsection in `research.md`.

This file exists for verification and audit — re-checking a claim,
tracking down the original paper, or reviewing this document's rigor —
not for the skill's runtime use.

---

<a id="anchoring-first-offers"></a>
...
<a id="deflecting-salary-history"></a>
...
**Tactical-response sourcing:** career-advice practitioner content
(Robert Half, Indeed, Coursera, and similar career-advice publishers) —
see `research.md` for how this is graded and used; no individually dated
articles were cited, since this is aggregated practitioner convergence
rather than a single source.

---

<a id="integrative-negotiation"></a>
...
Additional citations embedded in `research.md`'s findings for this
subsection: Froman, L.A. & Cohen, M.D. (1970). Compromise and logroll:
Comparing the efficiency of two bargaining processes. *Behavioral
Science*, 15(2), 180–183. Tajima, M. & Fraser, N.M. (2001). Logrolling
Procedure for Multi-Issue Negotiation. *Group Decision and Negotiation*,
10(3), 217–235. Leonardelli, G.J., Gu, J., McRuer, G., Medvec, V.H., &
Galinsky, A.D. (2019). Multiple equivalent simultaneous offers (MESOs)
reduce the negotiator dilemma: How a choice of first offers increases
economic and relational outcomes. *Organizational Behavior and Human
Decision Processes*, 152, 64–83.

---

<a id="gender-framing-effects"></a>
...
<a id="deadline-pressure-tactics"></a>
...
Additional citation embedded in `research.md`'s findings for this
subsection: Stuhlmacher, A.F. & Champagne, M.V. (2000). The impact of
time pressure and information on negotiation process and decisions.
*Group Decision and Negotiation*, 9(6), 471–491.
...
September 2026). Cooley LLP, *Venture Financing Report* (quarterly
series; Q1 2026 edition checked directly, cooley.com) — an aggregated
survey of deal terms across Cooley's own venture financing practice. The
Holloway Guide to Venture Capital, "Liquidation Preference," holloway.com,
edition 1.1.4, updated September 15, 2023 — practitioner reference
explaining preference-stack mechanics.

A Carta figure surfaced in search results (~70% of Series A financings
use 1x non-participating preferred, as of 2023) — see `research.md` for
why it's treated as unverified secondary data rather than a primary
citation.

---

<a id="409a-valuation-gap"></a>
...
revision (the last full revision as of September 2026; a working draft of
an updated edition was released by AICPA's Financial Reporting Executive
Committee for public comment in December 2025, with comments due June 1,
2026, but was not yet a finalized, citable edition) — the technical
valuation-methodology document (option-pricing method,
...
<a id="iso-nso-tax-treatment"></a>
### ISO vs. NSO Tax Treatment and AMT
